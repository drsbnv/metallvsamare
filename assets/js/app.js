...
var titleModal = document.querySelector('#response_modal h3');
var textModal = document.querySelector('#response_modal .content p');
var successArr = ['Спасибо!', 'Ваша заявка успешно отправлена!'];
var errorArr = ["Ошибка", "Перезагрузите страницу и попробуйте снова"];
...
function showErrorMes(form, el, text) {
  var field = form.querySelector(el);
...
document.querySelectorAll("form").forEach(function (form) {
  ...
  form.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee(e) {
      var formData, params, url, replUrl, source;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              params = new URLSearchParams(_toConsumableArray(new FormData(e.target).entries()));
            ...
            case 5:
              ...
              if (getCookie('__gtm_campaign_url')) {
                source = new URL(getCookie('__gtm_campaign_url'));
            ...
            case 16:
              ...
              _context.t0 = _context.t1.then.call(_context.t1, _context.t2);
              _context.next = 20;
            ...
            case 20:
              ...
              _context.t0["catch"].call(_context.t0, _context.t3);
...
swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_0__.Lazy, swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination, swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_0__.EffectFade]);
var bannerSlider;
var loop = false;
...
var initSlider = function initSlider() {
  ...
  bannerSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.banner-slider', {
    loop: loop,
    slidesPerView: 1,
    speed: 1000,
    preloadImages: false,
...
initSlider(0, loop);
var galarySlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.galary-slider', {
  loop: false,
  speed: 1000,
  spaceBetween: 20,
  preloadImages: false,
...
galarySlider.on('lazyImageReady', function (swiper, slideEl, imageEl) {
  setTimeout(function () {
    var parent = document.querySelector('.galary-slider');
    var active = parent.querySelector('.swiper-slide-active');
    var slides = parent.querySelectorAll('.galary-slide');
    var height = active.clientHeight;
    slides.forEach(function (slide) {
      slide.style.minHeight = "".concat(height, "px");
    });
  }, 100);
});
